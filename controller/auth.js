  ...
  async postSignup(req, res) {
    ...
    if (!name || !email || !password || !cPassword) {
      error = {
        ...
        cPassword: "No puede estar vacio",
      };
    ...
    if (name.length < 3 || name.length > 25) {
      ...
      if (validateEmail(email)) {
        ...
        if ((password.length > 255) | (password.length < 8)) {
          error = {
            ...error,
            password: "La contraseña debe tener 8 caracteres",
            name: "",
            email: "",
          };
          return res.json({ error });
          ...
          try {
            ...
            if (data) {
              ...
              newUser
                ...
                .then((data) => {
                  return res.json({
                    success: "Cuenta creada con éxito. Por favor Iniciar sesión",
                  });
                })
                .catch((err) => {
                  console.log(err);
