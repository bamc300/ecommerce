...
const Signup = (props) => {
  ...
  const formSubmit = async () => {
    ...
    if (data.cPassword !== data.password) {
      return setData({
        ...data,
        error: {
          cPassword: "Contraseñas no coinciden",
  ...
  return (
    <Fragment>
      <div className="text-center text-2xl mb-6">Registrarme</div>
      <form className="space-y-4">
        ...
        <div className="flex flex-col">
          <label htmlFor="email">
            Correo<span className="text-sm text-gray-600 ml-1">*</span>
          </label>
          <input
            onChange={(e) =>
              setData({
        ...
        <div className="flex flex-col space-y-2 md:flex-row md:justify-between md:items-center">
          <div>
            ...
            <label htmlFor="rememberMe">
              recordarme<span className="text-sm text-gray-600">*</span>
            </label>
          </div>
