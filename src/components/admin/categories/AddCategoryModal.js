        ...
        <div className="relative bg-white w-12/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4  overflow-y-auto px-4 py-4 md:px-8">
          ...
          <form className="w-full" onSubmit={(e) => submitForm(e)}>
            ...
            <div className="flex flex-col space-y-1 w-full">
              <label htmlFor="description">Descripcion de la categoria</label>
              <textarea
                onChange={(e) =>
                  setFdata({
                    ...fData,
            ...
            <div className="flex flex-col space-y-1 w-full">
              <label htmlFor="name">Imagen de la categoria</label>
              <input
                accept=".jpg, .jpeg, .png"
                onChange={(e) => {
                  setFdata({
            ...
            <div className="flex flex-col space-y-1 w-full">
              <label htmlFor="status">Estado de la categoria</label>
              <select
                name="status"
                onChange={(e) =>
                  setFdata({
